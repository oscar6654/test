...
class App extends React.Component {
  ...
  handleCheckboxChange(event) {
    if(this.state.accepted)//check current state
    {
      this.setState({accepted: false}) //set the state to false
    }
    else{
      this.setState({accepted: true}) //set the state to true
    }
    ...
    return (
      <div>
        <div className="letter-body">
          ...
          <p>Dear Addressee,</p>
          <div>
            <AcceptanceLetterText accepted = {this.state.accepted}/>
            <RejectionLetterText accepted = {this.state.accepted} />
          </div>
          <br />
          <p>Yours sincerely,</p>
